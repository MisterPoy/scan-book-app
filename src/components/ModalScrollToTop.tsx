...
export default function ModalScrollToTop({ containerRef }: ModalScrollToTopProps) {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="absolute bottom-6 right-6 z-10 p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all cursor-pointer flex items-center justify-center group"
