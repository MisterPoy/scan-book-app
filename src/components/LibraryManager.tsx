        ...
        <div className="p-6">
          ...
          {showCreateForm && (
            <div className="bg-gray-50 rounded-lg p-4 mb-6 border">
              ...
              <form
                onSubmit={
                  editingLibrary ? handleUpdateLibrary : handleCreateLibrary
                }
                className="space-y-4"
              >
                ...
                <div className="flex justify-end gap-3">
                  ...
                  >
                    {creating || updating ? (
                      ...
                      <>
                        {editingLibrary ? (
                          <PencilSimple size={16} className="inline mr-2" />
                        ) : (
          ...
          {libraries.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Créez votre première bibliothèque pour organiser vos livres
              </p>
            </div>
          ) : (
              ...
              {libraries.map((library) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div
                        ...
                        style={{
                          backgroundColor: library.color || PRESET_COLORS[0],
                        }}
                      >
                  ...
                  <div className="text-xs text-gray-500">
                    Créée le{" "}
                    {new Date(library.createdAt).toLocaleDateString("fr-FR")}
                  </div>
                </div>
              ))}
            </div>
